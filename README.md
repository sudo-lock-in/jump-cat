...
Play as a cat and jump over enemy dogs. Simplistic and fun. Targetted for a younger demographic. The game has RNG which makes it more challenging; the dogs have a different spacing each time they come back on screen, rather than the same predictable pattern. Your score increases as each bad dog goes off screen. If you bump into a dog, you lose and have to restart. Overall, I learnt a lot while working on this and PyGame is a great library. I used online resources for the graphics, CTTO.
### Controls
<ul>
